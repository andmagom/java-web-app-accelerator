...
```json
{
  "projectName" : "andmagom-java-web-app",
  "repositoryPrefix" : "index.docker.io/andrs1294/testappaccelerator"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->andmagom-java-web-ap...(truncated)]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].merge.transformations[0].sources[1].<combo>.transformations[1].transformations[1] (ReplaceText)
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->index.docker.io/andr...(truncated)]
